...
"""Verify that starting nirigecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start nirigecoin with -h for help text")
        ...
        self.log.info("Start nirigecoin with -version for version information")
        ...
        self.log.info("Start nirigecoind with -fakearg to make sure it does not start")
