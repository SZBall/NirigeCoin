# Support for Output Descriptors in Nirigecoin Core

Since Nirigecoin Core v0.17, there is support for Output Descriptors. This is a
...
on Nirigecoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Nirigecoin Core wallets, a convenience function `combo` is
