...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " nirigecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  nirigecoin-tx [options] <hex-tx> [commands]  Update hex-encoded nirigecoin transaction\n" +
            "or:     nirigecoin-tx [options] -create [commands]   Create hex-encoded nirigecoin transaction\n" +
            "\n";
