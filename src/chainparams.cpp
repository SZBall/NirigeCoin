...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.nirigecoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.nirigecointools.com");
        vSeeds.emplace_back("dnsseed.nirigecoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.nirigecointools.com");
        vSeeds.emplace_back("seed-b.nirigecoin.loshan.co.uk");
